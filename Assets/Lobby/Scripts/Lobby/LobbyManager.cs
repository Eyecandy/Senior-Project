...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        {
            Debug.Log("LobbyManager: OLCSC(): Scene Changed");
            if (SceneManager.GetSceneAt(0).name == lobbyScene)
            {
                Debug.Log("LobbyManager: OLCSC(): In LOBBY");
...
//                _countdownTimer.GetComponent<CountdownTimer>().enabled = true;
        ...
        #region DisplayIsConnecting Panel & SetServerInfo in TopPanel
        ...
        {
            backDelegate(); //run callback attached
			topPanel.isInGame = false;
        }

        #region Server management & Button callbacks
